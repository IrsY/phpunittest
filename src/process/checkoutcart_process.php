...
if ( $_SESSION['checkout_step'] !== 'finish') {
    ...
    function sendEmail($date)
    {
        ...
        $message = "Thank you for purchasing from Keyboarder";

        $mail = new PHPMailer(true);
        $mail->isSMTP();
        $mail->Host = 'smtp.gmail.com';
        $mail->SMTPAuth = true;
        $mail->Username = 'bot1.keyboarder.2023@gmail.com';
        $mail->Password = 'obasyqmkfxierfgl';
        $mail->Port = 465;
        $mail->SMTPSecure = 'ssl';
        $mail->isHTML(true);

        $mail->setFrom($email, 'Keyboarder');
