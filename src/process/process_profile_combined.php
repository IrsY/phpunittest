...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($change_password === "yes") {
        ...
        logMessage("application.log", "Profile information and password has been updated for user $customer_id from IP $ip");
    } else {
        ...
        logMessage("application.log", "Profile information has been updated for user $customer_id from IP $ip");
    }
