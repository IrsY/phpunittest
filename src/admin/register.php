                        ...
                        <div class="login-form">
                            ...
                            <form action="process/process_register.php" method="post">
                                <p>
                                    ...
                                    <input type="email" id="admin_email" name="admin_email" placeholder="Enter Email" required>
                                </p>
                                <p>
                                    <label for="admin_pwd">Password: <span>*</span></label>
                                    <input type="password" id="admin_pwd" name="admin_pwd" placeholder="Enter Password" required>
                                </p>
                                <p>
                                    <label for="admin_confirm_pwd">Confirm Password: <span>*</span></label>
                                    <input type="password" id="admin_confirm_pwd" name="admin_confirm_pwd" placeholder="Confirm Password" required>
                                </p>
