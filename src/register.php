<?php
session_start();
// include_once "sessions/sessiontimeout.php";
$_SESSION['csrf_token'] = bin2hex(random_bytes(32));
?>
<html lang="en">
    <head>
        <?php include_once "components/essential.inc.php"; ?>
                        ...
                        <div class="login-form">
                            ...
                            <form action="process/process_register.php" method="post">
                                <p>
                                    ...
                                    <input type="text" id="customer_fname" name="customer_fname" placeholder="Enter First Name" minlength="3" maxlength="20" required>
                                </p>
                                <p>
                                    <label for="customer_lname">Last Name: <span>*</span></label>
                                    <input type="text" id="customer_lname" name="customer_lname" placeholder="Enter Last Name" minlength="3" maxlength="20" required>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <input type="text" id="customer_address" name="customer_address" placeholder="Enter Address" minlength="10" maxlength="30" required>
                                </p>
                                <p>
                                    <label for="customer_number">Phone Number: <span>*</span></label>
                                    <input type="tel" id="customer_number" name="customer_number" placeholder="Enter Phone Number" minlength="8" maxlength="8" required>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <input type="password" id="confirm_pwd" name="confirm_pwd" placeholder="Confirm Password" minlength="12" maxlength="70"required>
                                </p>
