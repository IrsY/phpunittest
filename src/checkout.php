            ...
            <form action="process/payment_process.php" method="POST">
                <div class="form-row">
                    <div class="form-col-50">
                        ...
                        <input class="form-input" type="text" id="fname" name="fname" placeholder="John M. Doe"
                            required>
                        <label class="form-label" for="email"><i class="fa fa-envelope"></i> Email</label>
                        <input class="form-input" type="text" id="email" name="email" placeholder="john@example.com"
                            required>
                        <label class="form-label" for="adr"><i class="fa fa-address-card-o"></i> Address</label>
                        <input class="form-input" type="text" id="adr" name="adr" placeholder="542 W. 15th Street"
                            required>
                        <label class="form-label" for="city"><i class="fa fa-institution"></i> City</label>
                        <input class="form-input" type="text" id="city" name="city" placeholder="New York" required>
                        <div class="form-row">
                            <div class="form-col-50">
                            ...
                            <div class="form-col-50">
                                ...
                                <input class="form-input" type="number" id="zip" name="zip" placeholder="10001">
                            </div>
                        </div>
                    </div>
                    <div class="form-col-50">
